...
%
%----------------------------------------------------------------
% This script is a Reliff feature selection
...
[ranks,weights] = relieff(our_data4,winClass,10);

our_data5=our_data4(: , ranks(1:10)); %We take ten features
