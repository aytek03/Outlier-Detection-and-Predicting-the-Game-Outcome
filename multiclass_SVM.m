function [] = multiclass_SVM()

% AYTEKÝN YILDIZHAN
% N18147923
% CMP712 Machine Learning Project
%
% MultiSVM classification algorithm is presented.
...
Mdl = fitcecoc(our_data4,winClass,'Learners',t,... %
    'ClassNames',{'A','B','C','D'});

%cp = cvpartition(winClass,'k',5); % Stratified cross-validation
